...
import { fileIcons, getLocalFileSize } from '../../../utils/Constants';
import { styles } from '.';
...
type Props = {
  ...
  deleteSelectedFiles: (arg0?: ExtendedAsset) => void;
  setRenamingFile: (arg0: ExtendedAsset) => void;
  setRenameDialogVisible: (arg0: boolean) => void;
  setNewFileName: (arg0: string) => void;
};

export default function FileItemMedia({
  item,
  multiSelect,
  toggleSelect,
  setTransferDialog,
